...
int My_Strcmp(string str1, string str2) {
    int result = 0;
    int len1 = Alpha_index_structs(str1);
    int len2 = Alpha_index_structs(str2);
...
int My_Strcmp_back(string str1, string str2) {
    int result = 0;
    int len1 = Back_Alpha_index_structs(str1);
    int len2 = Back_Alpha_index_structs(str2);
    for (int step = 0; !(if_null(str1.line[len1 - step]) ||
                         if_null(str2.line[len2 - step])); step++) {
        if (str1.line[len1 - step] == str2.line[len2 - step])
            continue;
