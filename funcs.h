...
int CPABHEHUE_CTPOK(string str1, string str2);                              //strcmp() for structs
int CPABHEHUE_CTPOK_back(string str1, string str2);                        //reverse strcmp() for structs
...
int My_Strcmp_back(const char* str1, const char* str2);         //reverse strcmp()
